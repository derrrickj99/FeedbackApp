import { Home, Plus, Send, Trash, X } from "lucide-react";
...
const EditFeedbackForm = () => {
    ...
    const { questions, setQuestions, formTitle, setFormTitle, newQuestion, setNewQuestion, questionType, setQuestionType, loading, addQuestion, submitEditForm, deleteForm } = useEditform(params?.id as string);
            ...
            <div className="max-w-3xl mx-auto p-6">
                ...
                <div className="bg-white p-8 rounded-2xl border border-gray-200">
                    ...
                    <div className="flex justify-end gap-2">
                        <button
                            onClick={deleteForm}
                            className="px-8 py-4 bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-xl hover:from-red-700 hover:to-rose-700 disabled:from-gray-400 disabled:to-gray-400 disabled:cursor-not-allowed transition-all duration-200 font-bold text-lg flex items-center"
                        >
                            {loading ? (
                                <>
