...
export const Login: React.FC<LoginProps> = ({ onSwitchToRegister }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log(err);
            setError(`Login failed! ${getError(err).message} `);
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">Sign in to continue to Feedback Hub</p>
                </div>
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className="py-3 px-4 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center">
